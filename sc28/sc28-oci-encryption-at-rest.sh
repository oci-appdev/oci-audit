...
#   bash sc28/sc28-oci-encryption-at-rest.sh --select-scope
#   bash sc28/sc28-oci-encryption-at-rest.sh -i
#   bash sc28/sc28-oci-encryption-at-rest.sh -c <compartment-ocid>
#   bash sc28/sc28-oci-encryption-at-rest.sh -n 'VCN,Shared Services,CD3'
#   bash sc28/sc28-oci-encryption-at-rest.sh -r us-langley-1
#   bash sc28/sc28-oci-encryption-at-rest.sh -s 'volumes vault'
#   bash sc28/sc28-oci-encryption-at-rest.sh -o ./evidence        # writes into ./evidence/sc28/
...
oci_scope_print_scan_plan \
  "SC-28 ENCRYPTION AT REST" "sc28/sc28-oci-encryption-at-rest.sh" \
