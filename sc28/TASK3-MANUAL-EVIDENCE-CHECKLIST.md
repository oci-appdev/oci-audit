...
Use this checklist with `sc28/sc28-oci-encryption-at-rest.sh`. The collector proves
...
- [ ] Run `bash sc28/sc28-oci-encryption-at-rest.sh --selfcheck` and retain the result.
