...
#
# PYTHON FILES USED:
#   cm11-01/cm11-01-reconcile.py   entitlement expansion, installer/approval and
#                                  restricted-software reconciliation
#   Plus a short inline `python3 - <<'PY'` heredoc for CSV header validation.
#
...
#
# Usage:
#   bash cm11-01/cm11-01-software-installation-control.sh -r us-langley-1
...
#
#   bash cm11-01/cm11-01-software-installation-control.sh -i -r us-langley-1
...
POSTPROCESSOR="$SCRIPT_DIR/cm11-01-reconcile.py"
