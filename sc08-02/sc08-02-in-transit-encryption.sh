...
#
# PYTHON FILES USED:
#   No external .py file. A short inline `python3 - <<'PY'` heredoc is used for
#   CSV/evidence validation only; it ships inside this script and there is no
#   separate module to keep in step with it.
#
...
#
# Usage:
#   bash sc08-02/sc08-02-in-transit-encryption.sh                         # interactive by default
#   bash sc08-02/sc08-02-in-transit-encryption.sh --select-scope
#   bash sc08-02/sc08-02-in-transit-encryption.sh -i
#   bash sc08-02/sc08-02-in-transit-encryption.sh -c <compartment-ocid>   # approved automation
#   bash sc08-02/sc08-02-in-transit-encryption.sh -n 'VCN,Shared Services,CD3' # approved automation
#   bash sc08-02/sc08-02-in-transit-encryption.sh -r us-langley-1
#   bash sc08-02/sc08-02-in-transit-encryption.sh -s 'lb ipsec'
#   bash sc08-02/sc08-02-in-transit-encryption.sh -o ./evidence      # writes into ./evidence/sc08-02/
...
confirm_sc8_scan_plan() {
  ...
  echo "======================================================================"
  echo "Collector       : sc08-02/sc08-02-in-transit-encryption.sh"
...
echo "Manual evidence checklist: sc08-02/TASK2-MANUAL-EVIDENCE-CHECKLIST.md"
