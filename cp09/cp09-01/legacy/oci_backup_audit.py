#!/usr/bin/env python3
"""
cp09/cp09-01/legacy/oci_backup_audit.py
...
Usage (in Cloud Shell):
    python3 cp09/cp09-01/legacy/oci_backup_audit.py                 # all compartments, all services
    python3 cp09/cp09-01/legacy/oci_backup_audit.py -c <ocid>       # single compartment (no subtree)
    python3 cp09/cp09-01/legacy/oci_backup_audit.py -s volumes db   # only selected services
    python3 cp09/cp09-01/legacy/oci_backup_audit.py --region us-langley-1   # override region
