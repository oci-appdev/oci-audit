...
#
# PYTHON FILES USED:
#   No external .py file. The reconciliation engine is a large inline
#   `python3 - <<'PY'` heredoc in this script: rule identity, approval and
#   restricted-list matching, service-mapping validation and the scan summary
#   all live there. Edit it in place; there is no separate module.
#
...
#
#   bash cm07-01/cm07-01-open-ports-protocols-services.sh -i
#   bash cm07-01/cm07-01-open-ports-protocols-services.sh --select-scope
#   bash cm07-01/cm07-01-open-ports-protocols-services.sh -c <compartment-ocid>
#   bash cm07-01/cm07-01-open-ports-protocols-services.sh -n 'VCN,Shared Services,CD3'
#   bash cm07-01/cm07-01-open-ports-protocols-services.sh -r us-langley-1
#   bash cm07-01/cm07-01-open-ports-protocols-services.sh -d ingress
#   bash cm07-01/cm07-01-open-ports-protocols-services.sh -o ./evidence
...
#   bash cm07-01/cm07-01-open-ports-protocols-services.sh --inventory-only
