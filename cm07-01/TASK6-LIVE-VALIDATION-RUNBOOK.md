...
**Purpose:** close the two remaining items in the `cm07-01/CM07-CORRECTIVE-REVIEW.md`
acceptance gate. Everything else in that gate is done and covered by
`cm07-01/tests/test-cm07-01-corrective.sh`; these two require a real tenancy and cannot
