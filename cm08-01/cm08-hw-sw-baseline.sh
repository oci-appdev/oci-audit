...
#
# PYTHON FILES USED:
#   None directly. This is the raw collection engine (Bash + OCI CLI + jq). Its
#   output is normalized afterwards by the calling workflow's reconciler:
#   cm02-01/cm02-01-reconcile.py for CM-2, cm08-01/cm08-01-reconcile.py for CM-8.
#
# CANONICAL USE
...
#   and region handshake. Run cm02-01/cm02-01-configuration-baseline.sh for Task 8 or
#   cm08-01/cm08-01-component-inventory-baseline.sh for Task 9. The
...
case "${OCI_AUDIT_APPROVED_CALLER:-}" in
  CM02-01|CM08-01) ;;
  *)
    echo "ERROR: cm08-01/cm08-hw-sw-baseline.sh is an internal raw engine." >&2
    echo "Run cm02-01/cm02-01-configuration-baseline.sh or cm08-01/cm08-01-component-inventory-baseline.sh." >&2
    exit 2
    ;;
esac
