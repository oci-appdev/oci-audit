...
#   `cm08-01/cm08-hw-sw-baseline.sh`. This Task 9 workflow does not use the OCI Python
#   SDK.
#
# PYTHON FILES USED:
#   cm08-01/cm08-01-reconcile.py   component identity, prior-inventory
#                                  reconciliation, dispositions, monthly review
#   cm02-01/cm02-01-reconcile.py   shared normalizer, imported by the above as
#                                  its core; it lives under cm02-01/ and is
#                                  resolved by CORE_NORMALIZER, so moving either
#                                  file breaks the other
#
# Usage:
#   bash cm08-01/cm08-01-component-inventory-baseline.sh -r us-langley-1 --inventory-only
#   bash cm08-01/cm08-01-component-inventory-baseline.sh -i -r us-langley-1 --inventory-only
...
POSTPROCESSOR="$SCRIPT_DIR/cm08-01-reconcile.py"
CORE_NORMALIZER="$SCRIPT_DIR/../cm02-01/cm02-01-reconcile.py"
